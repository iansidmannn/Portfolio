...
const NOW = [
  ...
  {
    name: 'Diabetes Hacker',
    tagline: 'Log meals. Dose smarter.',
    icon: '/diabetes-hacker/icon.png',
    screen: '/diabetes-hacker/screens/home.png',
    href: 'https://apps.apple.com/us/app/diabetes-hacker-log-meals/id6770661711',
