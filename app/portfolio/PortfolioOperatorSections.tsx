...
type MenuId = 'viral' | 'revenue' | 'trends' | 'experiences'
...
export default function PortfolioOperatorSections() {
  ...
  useEffect(() => {
    const applyHash = () => {
      ...
      if (h === 'portfolio-experiences') setOpen('experiences')
    }
    applyHash()
      ...
      <div className="relative z-[1] container mx-auto max-w-5xl">
        <div className="grid grid-cols-4 gap-1.5 sm:gap-3">
          {MENU.map(({ id, title, shortTitle, Icon, panelId }) => {
            ...
            return (
              <div key={id} id={id === 'experiences' ? 'portfolio-experiences' : undefined} className="scroll-mt-28">
                <button
                  type="button"
