...
const keyMoments: KeyMoment[] = [
  ...
  },
  {
    ...
    metricLabel: 'Views On TikTok & Instagram',
    expandedContent:
      `Twenty-four hours after identifying our first viral video format for Piñata Farms we already had over a million views.

Apparently, boomers love stupid AI news.

"Breaking news, if you don't get gasoline for your car it will eventually run out of gas." That one hit 1.8 million views 🤣.

Anyways, I wanted to test how much audio was driving virality on these clips.

So I came up with a shareable script: "This just in, scientists now confirm the person receiving this video is mad cute. Have a great day cutie <3"

I re-prompted the voice multiple times to get the pacing and pitch right, added fitting background music, and shipped it.

What happened next was insane: twenty-four hours later a user posted with the sound—and it was basically just snow on a hike—that clip did 4.6 million views.

A few days later the Brooklyn Nets used it and landed about 6 million views, then more teams piled in across the NBA, NFL, and NHL (including the official NFL TikTok account).

I couldn't help but join in. I posted something random on my personal account and pulled 152K views 🤣.

The sound is now at over 150 million views across Instagram and TikTok.

It was pretty cool watching a mini economy form around audio I'd engineered—but I had to kill it. As Piñata's solo organic operator I only had time for revenue-driving work.

Later that same month I identified and launched a feature that grabbed 6,000 organic downloads in three days—but that's a story for another time 😁`,
    links: [
