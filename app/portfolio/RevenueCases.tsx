...
const cases: RevenueCase[] = [
  {
    ...
    expandedContent:
      "A lot of people mess up on execution of viral videos. I actually refilmed the video that brought in $5k in sales 8 different times to make sure my movements perfectly matched the audio, and included things to keep my target audience interested until the next main section.\n\nThis is the kind of execution you can only build through years of experience, and that's part of why when I find a working format, I can rip it consistently and continue to get views & revenue. The single best run hit 5.8M views, 282K shares, and brought in 193 new customers — $5,000 in sales from one post.\n\nHow I Started:\nIdentified unmet demand in the Gen Z consumer space → built the brand that was missing in the form of a clothing brand → $4k profit/mo in 3 months.\n\nGTM was viral Instagram content.\n\n13M views & $4k profit/mo 📈",
    links: [
