      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          <p className="text-lg text-gray-300 leading-relaxed">
            ...
            I know my past content experience might not mirror the exact things a role like that tradtionally needs. I know, I ask you tolook at my work as proof that
