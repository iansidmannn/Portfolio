      ...
      <div className="container mx-auto max-w-4xl">
        ...
        >
          <p className="text-lg text-gray-300 leading-relaxed">
            ...
            I know my past content experience might not mirror the exact things a role like that tradtionally needs. All I ask is that you look at my work as proof that
