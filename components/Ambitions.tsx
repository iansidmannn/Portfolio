    ...
    <section className="pt-32 pb-16 px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        >
          ...
          Right now, I'm very focused on getting involved in a startup & molding my skills to that space. If you give me the chance to do that I will work so hard for you.
